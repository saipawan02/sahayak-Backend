...
from api.update_database import video_uploads, pdf_uploads
...
app.include_router(video_uploads.router, prefix="/update_database")
app.include_router(pdf_uploads.router, prefix="/update_database")
